...
export class BinaryResourceView extends UI.VBox {
    ...
    constructor(base64content, contentUrl, resourceType) {
        super();
        this.registerRequiredCSS('network-standalone/binaryResourceView.css');
        ...
        this._binaryViewTypeCombobox = new UI.ToolbarComboBox(
            this._binaryViewTypeChanged.bind(this),
            ls`Binary view type`
        );
    ...
    _getCurrentViewObject() {
        ...
        console.assert(
            binaryViewObject,
            `No binary view found for binary view type found in setting 'binaryViewType': ${this._binaryViewTypeSetting.get()}`
        );
