...
export class NetworkLogViewColumns {
    ...
    _setupDataGrid() {
        ...
        for (const currentConfigColumn of defaultColumns) {
            const columnConfig = /** @type {!Network.NetworkLogViewColumns.Descriptor} */ (Object.assign(
                {},
                defaultColumnConfig,
                currentConfigColumn
            ));
        ...
        this._dataGrid.element.addEventListener(
            'mousedown',
            event => {
    ...
    _setupWaterfall() {
        ...
        this._waterfallColumn.element.addEventListener('mousewheel', this._onMouseWheel.bind(this, false), {
            passive: true
        });
        ...
        this._waterfallScrollerContent = this._waterfallScroller.createChild(
            'div',
        ...
        this._dataGrid.addEventListener(
            ...
            this._redrawWaterfallColumn.bind(this)
        );
    ...
    _redrawWaterfallColumn() {
        if (!this._waterfallRequestsAreStale) {
            ...
            this._waterfallColumn.update(
                this._activeScroller.scrollTop,
                this._eventDividersShown ? this._eventDividers : undefined
            );
            return;
        }
        this._syncScrollers();
    ...
    _createWaterfallHeader() {
        this._waterfallHeaderElement = this._waterfallColumn.contentElement.createChild(
            'div',
            'network-waterfall-header'
        );
        this._waterfallHeaderElement.addEventListener('click', waterfallHeaderClicked.bind(this));
        this._waterfallHeaderElement.addEventListener('contextmenu', event =>
            this._innerHeaderContextMenu(new UI.ContextMenu(event))
        );
        ...
        this._waterfallHeaderElement
            .createChild('div', 'sort-order-icon-container')
    ...
    _innerHeaderContextMenu(contextMenu) {
        ...
        responseSubMenu
            .footerSection()
            .appendItem(Common.UIString('Manage Header Columns\u2026'), this._manageCustomHeaderDialog.bind(this));
        ...
        waterfallSubMenu
            .defaultSection()
            .appendCheckboxItem(
                Common.UIString('Total Duration'),
    ...
    _manageCustomHeaderDialog() {
        ...
        const manageCustomHeaders = new NetworkManageCustomHeadersView(
            customHeaders,
            headerTitle => !!this._addCustomHeader(headerTitle),
            this._changeCustomHeader.bind(this),
        ...
        return {
            ...
            show: popover => {
                const content = RequestInitiatorView.createStackTracePreview(
                    /** @type {!SDK.NetworkRequest} */ (request),
                    this._popupLinkifier,
                    false,
