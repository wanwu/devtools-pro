...
export class BlockedURLsPane extends UI.VBox {
    constructor() {
        super(true);
        this.registerRequiredCSS('network-standalone/blockedURLsPane.css');
        ...
        this._enabledCheckbox = new UI.ToolbarCheckbox(
            Common.UIString('Enable request blocking'),
            undefined,
            this._toggleEnabled.bind(this)
        );
        ...
        this._list.registerRequiredCSS('network-standalone/blockedURLsPane.css');
    ...
    _createEditor() {
        ...
        titles.createChild('div').textContent = Common.UIString(
