...
export class NetworkManageCustomHeadersView extends UI.VBox {
    ...
    constructor(columnData, addHeaderColumnCallback, changeHeaderColumnCallback, removeHeaderColumnCallback) {
        super(true);
        this.registerRequiredCSS('network-standalone/networkManageCustomHeadersView.css');
        ...
        this._list.registerRequiredCSS('network-standalone/networkManageCustomHeadersView.css');
        ...
        this.contentElement.appendChild(
            UI.createTextButton(
                Common.UIString('Add custom header\u2026'),
    ...
    _headersUpdated() {
        this._list.clear();
        this._columnConfigs.forEach(headerData =>
            this._list.appendItem({header: headerData.title}, headerData.editable)
        );
    }
    ...
    _createEditor() {
        ...
        fields
            .createChild('div', 'custom-headers-header')
