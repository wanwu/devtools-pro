...
// ApplicationCache.
Protocol.inspectorBackend.registerEvent('ApplicationCache.applicationCacheStatusUpdated', [
    'frameId',
    'manifestURL',
    'status'
]);
...
Protocol.inspectorBackend.registerEvent('DOMStorage.domStorageItemUpdated', [
    'storageId',
    'key',
    'oldValue',
    'newValue'
...
Protocol.inspectorBackend.registerEvent('Network.dataReceived', [
    'requestId',
    'timestamp',
    'dataLength',
    'encodedDataLength'
]);
Protocol.inspectorBackend.registerEvent('Network.eventSourceMessageReceived', [
    'requestId',
    'timestamp',
    'eventName',
    'eventId',
...
Protocol.inspectorBackend.registerEvent('Network.loadingFailed', [
    'requestId',
    'timestamp',
    'type',
    'errorText',
...
Protocol.inspectorBackend.registerEvent('Network.loadingFinished', [
    'requestId',
    'timestamp',
    'encodedDataLength',
    'shouldReportCorbBlocking'
]);
Protocol.inspectorBackend.registerEvent('Network.requestIntercepted', [
    'interceptionId',
    'request',
    'frameId',
    'resourceType',
...
Protocol.inspectorBackend.registerEvent('Network.requestWillBeSent', [
    'requestId',
    'loaderId',
    'documentURL',
    'request',
...
Protocol.inspectorBackend.registerEvent('Network.responseReceived', [
    'requestId',
    'loaderId',
    'timestamp',
    'type',
...
Protocol.inspectorBackend.registerEvent('Network.webSocketHandshakeResponseReceived', [
    'requestId',
    'timestamp',
    'response'
]);
Protocol.inspectorBackend.registerEvent('Network.webSocketWillSendHandshakeRequest', [
    'requestId',
    'timestamp',
    'wallTime',
    'request'
]);
Protocol.inspectorBackend.registerEvent('Network.requestWillBeSentExtraInfo', [
    'requestId',
    'blockedCookies',
    'headers'
]);
Protocol.inspectorBackend.registerEvent('Network.responseReceivedExtraInfo', [
    'requestId',
    'blockedCookies',
    'headers',
    'headersText'
...
Protocol.inspectorBackend.registerEvent('Page.javascriptDialogOpening', [
    'url',
    'message',
    'type',
    'hasBrowserHandler',
...
Protocol.inspectorBackend.registerEvent('Security.securityStateChanged', [
    'securityState',
...
Protocol.inspectorBackend.registerEvent('Storage.indexedDBContentUpdated', [
    'origin',
    'databaseName',
    'objectStoreName'
]);
...
Protocol.inspectorBackend.registerCommand(
    ...
    [
        ...
        {name: 'flatten', type: 'boolean', optional: true},
        {name: 'windowOpen', type: 'boolean', optional: true}
    ],
    [],
    false
);
...
Protocol.inspectorBackend.registerEvent('Tracing.tracingComplete', [
    'dataLossOccurred',
    'stream',
    'traceFormat',
    'streamCompression'
...
Protocol.inspectorBackend.registerEvent('Fetch.requestPaused', [
    'requestId',
    'request',
    'frameId',
    'resourceType',
...
Protocol.inspectorBackend.registerEvent('Fetch.authRequired', [
    'requestId',
    'request',
    'frameId',
    'resourceType',
...
Protocol.inspectorBackend.registerEvent('WebAudio.nodesConnected', [
    'contextId',
    'sourceId',
    'destinationId',
    'sourceOutputIndex',
...
Protocol.inspectorBackend.registerEvent('WebAudio.nodesDisconnected', [
    'contextId',
    'sourceId',
    'destinationId',
    'sourceOutputIndex',
...
Protocol.inspectorBackend.registerEvent('WebAudio.nodeParamConnected', [
    'contextId',
    'sourceId',
    'destinationId',
    'sourceOutputIndex'
]);
Protocol.inspectorBackend.registerEvent('WebAudio.nodeParamDisconnected', [
    'contextId',
    'sourceId',
    'destinationId',
    'sourceOutputIndex'
...
Protocol.inspectorBackend.registerEvent('Debugger.paused', [
    'callFrames',
    'reason',
    'data',
    'hitBreakpoints',
...
Protocol.inspectorBackend.registerEvent('Debugger.scriptFailedToParse', [
    'scriptId',
    'url',
    'startLine',
    'startColumn',
...
Protocol.inspectorBackend.registerEvent('Debugger.scriptParsed', [
    'scriptId',
    'url',
    'startLine',
    'startColumn',
...
Protocol.inspectorBackend.registerEvent('Runtime.consoleAPICalled', [
    'type',
    'args',
    'executionContextId',
    'timestamp',
